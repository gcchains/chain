...
func Test_decryptPayload(t *testing.T) {
	var (
		cipherPayloadForTest = hexutil.MustDecode("0x216ae6a5c5e0a016d8a95d367b5798cd4bc7f1c51301aadf02e87e1be140bc50ddbfee4b3beecc83594d9f49")
		symmetricKey         = hexutil.MustDecode("0x4f2f80b8ec728f9b583180216127c070e6b75fc0db354d2a080b6ae143ea65f5")
...
func (fakeWallet) SelfDerive(base accounts.DerivationPath, chain gcchain.ChainStateReader) {
	panic("implement me")
}
...
func getDecryptor() accounts.AccountRsaDecryptor {
	return &fakeAccountBasedDecryptor{
		privateKey: "0xb71c71a67e1177ad4e901695e1b419ee17ae16c6618d313eac2f96dbcda3f291",
		publicKey:  "0x04ca634cae0d19acb401d8a4c6b6fe8c55b70d115bf400169cc1400f3258cd31387574077f301b421bc84df7266c44e9e6d569fc56be00812904767bf5ccd1fc7f",
	}
}

func getTestParticipants() []string {
	return []string{
		"0x04ca634cae0d49acb401d8a4c6b6fe8c55b70d115bf400769cc1401f3258cd31387574077f301b421bc84df7266c14e9e6d569fc56be00812904767bf5ccd1fc7f",
		"0x04ca634cae0d49acb401d8a16b6fe8c55b70d115bf400769cc1400f3258cd31387574077f301b421bc84df7266c41e9e6d569fc56be00812904767bf5ccd1fc7f"}
}

func getOtherParticipants() []string {
	return []string{
		"0x04ed7c2d05e792b6b357a0461adceb0597e1d3988ea95af8eb8a0842cff763b79032103f064b5947bbe3610f45e72e794d9a9a976d6dd5d5181ba08b6038e10772",
		"0x04ed7c2d05e792b6b357a0461adceb0597e5d3988ea95af8eb8a0842cff763b79032103f064b5947bbe3610f45e72e79419a9a976d6dd5d5181ba08b6038e10772"}
}
