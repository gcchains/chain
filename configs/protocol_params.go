...
const (
	...
	cep1BlocksY1     = 366 * cep1BlocksPerDay 
...
var (
	cep1BlockRewardSupplyY1 = new(big.Int).Mul(big.NewInt(40002356), big.NewInt(1e+18))
	cep1BlockRewardSupplyY2 = new(big.Int).Mul(big.NewInt(29990336), big.NewInt(1e+18))
	cep1BlockRewardSupplyY3 = new(big.Int).Mul(big.NewInt(22485268), big.NewInt(1e+18))
	cep1BlockRewardSupplyY4 = new(big.Int).Mul(big.NewInt(16991904), big.NewInt(1e+18))
	cep1BlockRewardSupplyY5 = new(big.Int).Mul(big.NewInt(127338272), big.NewInt(1e+17))

	// the calculation is based on 10 s a block	is generated.
	cep1BlockRewardY1 = new(big.Int).Div(cep1BlockRewardSupplyY1, big.NewInt(cep1BlocksY1)) // reward 12.65 gcc per block
	cep1BlockRewardY2 = new(big.Int).Div(cep1BlockRewardSupplyY2, big.NewInt(cep1BlocksY2)) // reward 9.51 gcc per block
	cep1BlockRewardY3 = new(big.Int).Div(cep1BlockRewardSupplyY3, big.NewInt(cep1BlocksY3)) // reward 7.13 gcc per block
	cep1BlockRewardY4 = new(big.Int).Div(cep1BlockRewardSupplyY4, big.NewInt(cep1BlocksY4)) // reward 5.39 gcc per block
	cep1BlockRewardY5 = new(big.Int).Div(cep1BlockRewardSupplyY5, big.NewInt(cep1BlocksY5)) // reward 4.03 gcc per block
