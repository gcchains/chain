...
func PrepareCpclient(endpoint string) *gcclient.Client {
...
func PrepareAll(ctx *cli.Context, withTransactor bool) (addr common.Address, client *gcclient.Client, key *keystore.Key) {
...
func WaitMined(client *gcclient.Client, tx *types.Transaction, err error) {
	if err != nil {
