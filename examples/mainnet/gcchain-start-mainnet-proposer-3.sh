...
# proposer 16-19
nohup $gcchain $args --ipcaddr ${ipc_path_base}16 --datadir data/data16 --rpcaddr 0.0.0.0:8516 --port 30326 --mine \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}17 --datadir data/data17 --rpcaddr 0.0.0.0:8517 --port 30327 --mine \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}18 --datadir data/data18 --rpcaddr 0.0.0.0:8518 --port 30328 --mine \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}19 --datadir data/data19 --rpcaddr 0.0.0.0:8519 --port 30329 --mine \
