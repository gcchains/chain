...
nohup $gcchain $args --ipcaddr ${ipc_path_base}14 --datadir data/data14 --rpcaddr 0.0.0.0:8514 --port 30324 --mine \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}15 --datadir data/data15 --rpcaddr 0.0.0.0:8515 --port 30325 --mine \
