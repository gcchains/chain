...
#args="run --networkid 1 --rpcapi personal,eth,gcc,admission,net,web3,db,txpool,miner,admin --linenumber --metricgateway http://192.168.50.251:9091"
args="run --networkid 1 --rpcapi personal,eth,gcc,admission,net,web3,db,txpool,miner,admin --linenumber  --runmode dev "
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}2 --datadir data/data2  --rpcaddr 0.0.0.0:8502 --port 30312 --mine \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}3 --datadir data/data3  --rpcaddr 0.0.0.0:8503 --port 30313 --mine \
         --profile data/data3 \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}4 --datadir data/data4  --rpcaddr 0.0.0.0:8504 --port 30314 --mine \
         --profile data/data4 \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}5 --datadir data/data5  --rpcaddr 0.0.0.0:8505 --port 30315 --mine \
         --profile data/data5 \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}6 --datadir data/data6  --rpcaddr 0.0.0.0:8506 --port 30316 --mine \
         --profile data/data6 \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}7 --datadir data/data7  --rpcaddr 0.0.0.0:8507 --port 30317 \
         --profile data/data7 \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}8 --datadir data/data8  --rpcaddr 0.0.0.0:8508 --port 30318 \
         --profile data/data8 \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}9 --datadir data/data9  --rpcaddr 0.0.0.0:8509 --port 30319 \
         --profile data/data9 \
...
nohup $gcchain $args --ipcaddr ${ipc_path_base}10 --datadir data/data10  --rpcaddr 0.0.0.0:8510 --port 30320 \
         --profile data/data10 \
...
# dlv --headless --listen=:2345 --api-version=2 debug github.com/ethereum/go-ethereum/cmd/gcchain -- $ARGS  --datadir $data_dir/data/dd3  --rpcport 8503 --port 30313 --unlock "0xe94b7b6c5a0e526a4d97f9768ad6097bde25c62a" --mine --minerthreads 1 --password conf-dev/passwords/password
