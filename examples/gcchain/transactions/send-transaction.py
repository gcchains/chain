...
def main():
    ...
    account1 = web3.toChecksumAddress('0xe94b7b6c5a0e526a4d17f9768ad6097bde25c62a')
    account2 = web3.toChecksumAddress('0x105302acebd0730e3a18a058d7d1cb1214c4a092')
    ...
    tx_hash = web3.eth.sendTransaction({'to': web3.toChecksumAddress('0xc05302ace1d0730e3a18a158d7d1cb1204c4a092'), 'from': web3.eth.coinbase, 'value': int(10),'gas':200000,'gasPrice':234512334421})
    print('\nwaitForTransactionReceipt:')
    tx_receipt = web3.eth.waitForTransactionReceipt(tx_hash)
    print(tx_receipt)
