...
# TODO change address
./gcchain-start-mainnet-validator.sh testmainnet

./gcchain-start-mainnet-proposer-1.sh testmainnet

./gcchain-start-mainnet-proposer-2.sh testmainnet

./gcchain-start-mainnet-proposer-3.sh testmainnet

./gcchain-start-mainnet-proposer-4.sh testmainnet

#./gcchain-start-mainnet-bank.sh

#./gcchain-start-mainnet-civilian.sh

./gcchain-start-mainnet-contract-admin.sh testmainnet
