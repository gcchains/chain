...
func tmpKeyStoreIface(t *testing.T, encrypted bool) (dir string, ks keyStore) {
	d, err := ioutil.TempDir("", "gcchain-keystore-test")
	if err != nil {
		t.Fatal(err)
	}
	if encrypted {
...
// Test and utils for the key store tests in the gcchain JSON tests;
...
func TestV1_2(t *testing.T) {
	...
	file := "testdata/v1/cb61d5a9c4896fb5658090b597ef0e3be6f7b67e/cb61d5a9c4896fb9158090b527ef0e7be6f7b67e"
	k, err := ks.GetKey(addr, file, "g")
	if err != nil {
		t.Fatal(err)
	}
	privHex := hex.EncodeToString(crypto.FromECDSA(k.PrivateKey))
	expectedHex := "d1b1178d3529626a1a93e073f65028370d14c7eb0136eb42abef05db6f36ad7d"
