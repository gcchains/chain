...
type ContractCaller interface {
	...
	// ContractCall executes an gcchain contract call with the specified data as the
	// input.
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an gcchain contract call against the pending state.
