...
// PeerInfo represents a short summary of the gcchain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version int      `json:"version"` // gcchain protocol version negotiated
...
// Handshake executes the gcchain protocol handshake, negotiating version number,
...
func (p *peer) Handshake(network uint64, ht *big.Int, head common.Hash, genesis common.Hash, isMinerOrValidator bool) (bool, error) {
	...
	log.Debug("handshaking with remote gcc peer...", "network", network, "blockchain hight", ht.Uint64(), "head", head.Hex(), "genesis", genesis.Hex(), "is Miner", isMinerOrValidator)
