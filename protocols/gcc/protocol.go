...
import (
	...
	"github.com/gcchains/chain/protocols/gcc/configs"
...
var ProtocolName = "gcc"

// ProtocolVersions are the versions of the gcchain protocol (first is primary).
var ProtocolVersions = []uint{configs.Gcc1}
