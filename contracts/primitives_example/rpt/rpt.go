...
// DeployRpt deploys a new gcchain contract, binding an instance of Rpt to it.
...
// Rpt is an auto generated Go binding around an gcchain contract.
type Rpt struct {
...
// RptCaller is an auto generated read-only Go binding around an gcchain contract.
type RptCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// RptTransactor is an auto generated write-only Go binding around an gcchain contract.
type RptTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// RptFilterer is an auto generated log filtering Go binding around an gcchain contract events.
type RptFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// RptSession is an auto generated Go binding around an gcchain contract,
// with pre-set call and transact options.
...
// RptCallerSession is an auto generated read-only Go binding around an gcchain contract,
// with pre-set call options.
...
// RptTransactorSession is an auto generated write-only Go binding around an gcchain contract,
// with pre-set transact options.
...
// RptRaw is an auto generated low-level Go binding around an gcchain contract.
type RptRaw struct {
	Contract *Rpt // Generic contract binding to access the raw methods on
}

// RptCallerRaw is an auto generated low-level read-only Go binding around an gcchain contract.
type RptCallerRaw struct {
	Contract *RptCaller // Generic read-only contract binding to access the raw methods on
}

// RptTransactorRaw is an auto generated low-level write-only Go binding around an gcchain contract.
