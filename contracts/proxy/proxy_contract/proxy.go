...
// DeployProxy deploys a new gcchain contract, binding an instance of Proxy to it.
...
// Proxy is an auto generated Go binding around an gcchain contract.
type Proxy struct {
...
// ProxyCaller is an auto generated read-only Go binding around an gcchain contract.
type ProxyCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ProxyTransactor is an auto generated write-only Go binding around an gcchain contract.
type ProxyTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ProxyFilterer is an auto generated log filtering Go binding around an gcchain contract events.
type ProxyFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ProxySession is an auto generated Go binding around an gcchain contract,
...
// ProxyCallerSession is an auto generated read-only Go binding around an gcchain contract,
...
// ProxyTransactorSession is an auto generated write-only Go binding around an gcchain contract,
...
// ProxyRaw is an auto generated low-level Go binding around an gcchain contract.
type ProxyRaw struct {
	Contract *Proxy // Generic contract binding to access the raw methods on
}

// ProxyCallerRaw is an auto generated low-level read-only Go binding around an gcchain contract.
type ProxyCallerRaw struct {
	Contract *ProxyCaller // Generic read-only contract binding to access the raw methods on
}

// ProxyTransactorRaw is an auto generated low-level write-only Go binding around an gcchain contract.
