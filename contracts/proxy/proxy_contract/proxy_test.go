...
func TestSignerRegisterProxyContractRegister(t *testing.T) {
	...
	proxyContratAddress := common.HexToAddress("0x7900Ad1d71fc5c57ba56e4b761de3c2264253335")
	...
	realAddr := common.HexToAddress("0x482fdc12cd9bc79ccb69644cb1ec46ff365f50b")
...
func deploySignerRegisterProxyContract() (*gcclient.Client, *ecdsa.PrivateKey, common.Address, int, *big.Int, *Proxy, context.Context, common.Address) {
