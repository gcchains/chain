...
const PdashProxyABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"proxy\",\"type\":\"address\"}],\"name\":\"getProxyFileNumber\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_addr\",\"type\":\"address\"}],\"name\":\"setProxyContractAddr\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"user\",\"type\":\"address\"},{\"name\":\"block_num\",\"type\":\"uint256\"}],\"name\":\"getProxyFileNumberInBlock\",\"outputs\":[{\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"updatePdashAddress\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"fileName\",\"type\":\"string\"},{\"name\":\"fileHash\",\"type\":\"bytes32\"},{\"name\":\"fileSize\",\"type\":\"uint256\"}],\"name\":\"proxyRegister\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"},{\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"proxyHistory\",\"outputs\":[{\"name\":\"fileName\",\"type\":\"string\"},{\"name\":\"fileHash\",\"type\":\"bytes32\"},{\"name\":\"fileSize\",\"type\":\"uint256\"},{\"name\":\"timeStamp\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"pdash\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"name\":\"_addr\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"}]"

// PdashProxyBin is the compiled bytecode used for deploying new contracts.
const PdashProxyBin = ``

// DeployPdashProxy deploys a new gcchain contract, binding an instance of PdashProxy to it.
...
// PdashProxy is an auto generated Go binding around an gcchain contract.
...
// PdashProxyCaller is an auto generated read-only Go binding around an gcchain contract.
type PdashProxyCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PdashProxyTransactor is an auto generated write-only Go binding around an gcchain contract.
type PdashProxyTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PdashProxyFilterer is an auto generated log filtering Go binding around an gcchain contract events.
type PdashProxyFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PdashProxySession is an auto generated Go binding around an gcchain contract,
...
// PdashProxyCallerSession is an auto generated read-only Go binding around an gcchain contract,
...
// PdashProxyTransactorSession is an auto generated write-only Go binding around an gcchain contract,
...
// PdashProxyRaw is an auto generated low-level Go binding around an gcchain contract.
type PdashProxyRaw struct {
	Contract *PdashProxy // Generic contract binding to access the raw methods on
}

// PdashProxyCallerRaw is an auto generated low-level read-only Go binding around an gcchain contract.
type PdashProxyCallerRaw struct {
	Contract *PdashProxyCaller // Generic read-only contract binding to access the raw methods on
}

// PdashProxyTransactorRaw is an auto generated low-level write-only Go binding around an gcchain contract.
...
func (_PdashProxy *PdashProxyTransactor) SetProxyContractAddr(opts *bind.TransactOpts, _addr common.Address) (*types.Transaction, error) {
	return _PdashProxy.contract.Transact(opts, "setProxyContractAddr", _addr)
}
...
func (_PdashProxy *PdashProxySession) SetProxyContractAddr(_addr common.Address) (*types.Transaction, error) {
	return _PdashProxy.Contract.SetProxyContractAddr(&_PdashProxy.TransactOpts, _addr)
}
...
// DeployProxyContractInterface deploys a new gcchain contract, binding an instance of ProxyContractInterface to it.
...
// ProxyContractInterface is an auto generated Go binding around an gcchain contract.
...
// ProxyContractInterfaceCaller is an auto generated read-only Go binding around an gcchain contract.
type ProxyContractInterfaceCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ProxyContractInterfaceTransactor is an auto generated write-only Go binding around an gcchain contract.
type ProxyContractInterfaceTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ProxyContractInterfaceFilterer is an auto generated log filtering Go binding around an gcchain contract events.
type ProxyContractInterfaceFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ProxyContractInterfaceSession is an auto generated Go binding around an gcchain contract,
// with pre-set call and transact options.
...
// ProxyContractInterfaceCallerSession is an auto generated read-only Go binding around an gcchain contract,
// with pre-set call options.
...
// ProxyContractInterfaceTransactorSession is an auto generated write-only Go binding around an gcchain contract,
// with pre-set transact options.
...
// ProxyContractInterfaceRaw is an auto generated low-level Go binding around an gcchain contract.
...
// ProxyContractInterfaceCallerRaw is an auto generated low-level read-only Go binding around an gcchain contract.
...
// ProxyContractInterfaceTransactorRaw is an auto generated low-level write-only Go binding around an gcchain contract.
