...
def test_case_1():
    ...
    civilian = "0x970c18A634B23c95a61746d172C48356ab58D8EC"
    owner = "0xb3801b874aDEA10c30b0c21CAe8b1b23d9625F84"
    password = "password"
    cf.personal.unlockAccount(civilian, password)
    cf.personal.unlockAccount(owner, password)
    print("balance of civilian: ", cf.fromWei(cf.gcc.getBalance(civilian), "ether"))
    ...
    print("============read configs================")
    rpt_ins = cf.gcc.contract(abi=config["abi"], address=address)
    ...
    cf.gcc.defaultAccount = civilian
