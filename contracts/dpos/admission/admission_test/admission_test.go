...
import (
	...
	contract "github.com/gcchains/chain/contracts/dpos/admission"
...
var (
	key0, _                  = crypto.HexToECDSA("b71c71a67e1177ad1e901695e1b4b9ee17ae16c1668d313eac2f96dbcda3f291")
	key1, _                  = crypto.HexToECDSA("8a1f9a8f1be41cd7ccb6168179afb4504aefe388d1e14474d32c41c72ce7b7a1")
	key2, _                  = crypto.HexToECDSA("49a7b37aa6f6645917e7b107e9d1c00d4fa71f18343b0d4122a4d1df64dd6fee")
...
func newTestBackend() *backends.SimulatedBackend {
	return backends.NewDposSimulatedBackend(core.GenesisAlloc{
		addr0: {Balance: new(big.Int).Mul(big.NewInt(1000000), big.NewInt(configs.Gcc))},
		addr1: {Balance: new(big.Int).Mul(big.NewInt(1000000), big.NewInt(configs.Gcc))},
		addr2: {Balance: new(big.Int).Mul(big.NewInt(1000000), big.NewInt(configs.Gcc))},
	})
}
