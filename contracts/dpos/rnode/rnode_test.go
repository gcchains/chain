...
var (
	ownerKey, _ = crypto.HexToECDSA("171c71a67e1177ad4e901695e1b419ee17ae16c6668d313eac2f96dbcd13f291")
	ownerAddr   = crypto.PubkeyToAddress(ownerKey.PublicKey)

	candidateKey, _ = crypto.HexToECDSA("2a1f9a8f95be41cd7ccb6168179afb4504ae1e388d1e14474d32c45172ce7b7a")
	candidateAddr   = crypto.PubkeyToAddress(candidateKey.PublicKey)

	candidate2Key, _ = crypto.HexToECDSA("cad9c8855b740a0fed4c221dbad0f33a83a49cad6b3fe8d5817ac83d38b6a19")
...
func TestRNodeJoinRNode(t *testing.T) {
	// deploy contract
	contractBackend := backends.NewDposSimulatedBackend(core.GenesisAlloc{
		ownerAddr:      {Balance: big.NewInt(1000000000000)},
		candidateAddr:  {Balance: new(big.Int).Mul(big.NewInt(1000000), big.NewInt(configs.Gcc))},
		candidate2Addr: {Balance: new(big.Int).Mul(big.NewInt(1000000), big.NewInt(configs.Gcc))}})
