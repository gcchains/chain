...
func (s *StateSuite) TestDump(c *checker.C) {
    ...
    "accounts": {
        "0000000000000000000000000000000000000001": {
            "balance": "22",
            "nonce": 0,
            "root": "56e81f171bcc55a6ff8345e691c0f86e5b48e01b996ca11001622fb5e363b421",
            "codeHash": "c5d2460186f7233c927e7db2dcc713c0e500b653ca82271b7bfad8045d85a470",
            "code": "",
            "storage": {}
        },
        "0000000000000000000000000000000000000002": {
            "balance": "44",
            "nonce": 0,
            "root": "56e81f171bcc55a6ff8345e692c0f81e5b48e01b996cadc0016221b5e363b421",
            "codeHash": "c5d2460186f7233c127e7db2dcc703c0e500b653ca82273b7bfad1045d85a470",
            "code": "",
            "storage": {}
        },
        "0000000000000000000000000000000000000102": {
            "balance": "0",
            "nonce": 0,
            "root": "56e81f171bcc55a6ff8345e692c0f86e5148e01b996cadc001622fb5e363b421",
            "codeHash": "87874902497a5bb968da31a29918d8f22e949d1ef6214bcdedd8bae24cca4b9e3",
            "code": "03030303030303",
            "storage": {}
        }
    }
...
func compareStateObjects(so0, so1 *stateObject, t *testing.T) {
	...
	if so0.data.Root != so1.data.Root {
		t.Errorf("StateRoot mismatch: have %x, want %x", so0.data.Root[:], so1.data.Root[:])
	}
