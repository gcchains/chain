...
type Genesis struct {
	...
	Dpos       types.DposSnap `json:"dpos"       toml:"dpos"`
}
...
// DefaultGenesisBlock returns the gcchain main net genesis block.
...
func newGenesisBlock() *Genesis {
	...
	return &Genesis{
		...
		Alloc: map[common.Address]GenesisAccount{
			candidates[0]: {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[1]: {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[2]: {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[3]: {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[4]: {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[5]: {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			...
			common.HexToAddress("0xb3801b8743dea10c30b0c21cae8b1923d9625f84"): {Balance: new(big.Int).Mul(big.NewInt(800000000), big.NewInt(configs.Gcc))}, // contract admin account
		},
		Dpos: types.DposSnap{
			Proposers:  configs.Proposers(),
			Seal:       types.DposSignature{},
			Sigs:       make([]types.DposSignature, configs.DefaultValidatorsNumber),
...
func newTestnetGenesisBlock() *Genesis {
	...
	return &Genesis{
		...
		Dpos: types.DposSnap{
			Proposers:  configs.Proposers(),
			Seal:       types.DposSignature{},
			Sigs:       make([]types.DposSignature, configs.TestnetValidatorsNumber),
			Validators: configs.Validators(),
		},
	}
}
...
func newMainnetGenesisBlock() *Genesis {
	...
	return &Genesis{
		...
		Alloc: map[common.Address]GenesisAccount{
			...
			candidates[6]:  {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[7]:  {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[8]:  {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[9]:  {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[10]: {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			candidates[11]: {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},

			// contract admin account 21
			common.HexToAddress("0x66961306fd78d39a4604167f59b25697bdad05c5"): {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			// bank 22
		...
		Dpos: types.DposSnap{
			Proposers:  configs.Proposers(),
			Seal:       types.DposSignature{},
			Sigs:       make([]types.DposSignature, configs.MainnetValidatorsNumber),
			Validators: configs.Validators(),
		},
	}
}
...
func newTestMainnetGenesisBlock() *Genesis {
	...
	return &Genesis{
		...
		Alloc: map[common.Address]GenesisAccount{
			...
			// contract admin account 21
			common.HexToAddress("0xb3801b8743dea10c30b0c21cae8b1923d9625f84"): {Balance: new(big.Int).Mul(big.NewInt(300000), big.NewInt(configs.Gcc))},
			// bank 22
			common.HexToAddress("0xabb528bffc707c2c507307e426ce810a7ad93ed6"): {Balance: new(big.Int).Mul(big.NewInt(1000000000), big.NewInt(configs.Gcc))},
		},
		Dpos: types.DposSnap{
			Proposers:  configs.Proposers(),
			Seal:       types.DposSignature{},
			Sigs:       make([]types.DposSignature, configs.TestMainnetValidatorsNumber),
			Validators: configs.Validators(),
		},
	}
}
