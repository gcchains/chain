...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gcchain.ipc", false, filepath.Join(os.TempDir(), "gcchain.ipc")},
		{"data", "gcchain.ipc", false, "data/gcchain.ipc"},
		{"data", "./gcchain.ipc", false, "./gcchain.ipc"},
		{"data", "/gcchain.ipc", false, "/gcchain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gcchain.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "gcchain.ipc", true, `\\.\pipe\geth.ipc`},
