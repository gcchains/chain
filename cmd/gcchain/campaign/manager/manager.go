...
import (
	...
	cc "github.com/gcchains/chain/tools/utility"
...
// GetStatus get status of gcchain node
...
func (c *Console) StartMining() error {
	...
	rnode := c.isRNode()
	if !rnode {
		c.output.Info("You are not rnode yet ,you will spend 200000 gcc to be rnode first")
	}
