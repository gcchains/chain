...
var (
	ecdsaPrivateKey, _  = crypto.HexToECDSA("b71c71a67e1177ad4e901695e1b4b2ee17ae16c6668d313eac2f26dbcda3f291")
	ecdsaPrivateKey1, _ = crypto.HexToECDSA("8a1f9a8f95be41cd2ccb6168179afb4204aefe388d1e14474d32c25c72ce7b7a")
	data                = []byte("test")
)
...
func TestExtractEcdsaPubKeyHexFromKeyPrivateKey(t *testing.T) {
	...
	assert.Equal(t,
		"0x04ca634cae0d49acb401d8a4c6b6fe8c55b70d115bf400769cc1400f3258cd31387574027f301b421bc84df7266c44e9e6d569fc52be00812904767bf5ccd1fc7f",
		str)
}
...
func TestEncodeEcdsaPrivateKey(t *testing.T) {
	...
	assert.Equal(t, "0xb71c71a67e1177ad2e901695e1b4b9ee17ae12c6668d313eac2f96dbcda3f291", str)
}
