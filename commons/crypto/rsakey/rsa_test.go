...
func TestLoadRsaKey3(t *testing.T) {
	...
	assert.Equal(t, "", string(pn.String()))
...
func TestEncodeDecodeRsaPublicKey(t *testing.T) {
	...
	assert.Equal(t, 65537, pe)
	assert.Equal(t, "", string(pn.String()))
